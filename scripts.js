...
const hskWords = [
    ...
    { char:'菲林', pinyin:'fēilín', meaning:'film (photographic)', example:'这个菲林还没做好。', exampleIndo:'Film ini belum selesai dibuat.' },
    { char:'估计', pinyin:'gūjì', meaning:'memperkirakan, mengira', example:'我估计今天下午生产会提前四个小时。', exampleIndo:'Saya perkirakan produksi akan selesai empat jam lebih awal hari ini.' },
    { char:'运营', pinyin:'yùnyíng', meaning:'operasional, machine running', example:'生产正在运营到6天。', exampleIndo:'Produksi sedang berjalan selama 6 hari.' },
    { char:'继续', pinyin:'jìxù', meaning:'melanjutkan', example:'我会继续在注塑部锻炼自己。', exampleIndo:'Aku akan terus berlatih di Departemen Injection Molding.' },
    { char:'拷贝纸', pinyin:'Kǎobèizhǐ', meaning:'Tissue paper', example:'请把机台上的拷贝纸拿给我。', exampleIndo:'Please hand me the tissue paper on the machine.' },
    { char:'芯纸', pinyin:'xīnzhǐ', meaning:'Sisi kertas', example:'这边的芯纸很差。', exampleIndo:'Sisi kertas bagian ini sangat buruk.' },
    { char:'不足/不够', pinyin:'bùzú/bugòu', meaning:'tidak cukup', example:'这盆里面还有1百个，不够还差一百个', exampleIndo:'Di dalam box ini baru ada 100, tidak cukup, masih kurang 100 lagi.' },
    { char:'诚信', pinyin:'chéngxìn', meaning:'kejujuran, kepercayaan（integritas）', example:'我们必须对客户诚信', exampleIndo:'Kita harus mendapat kepercayaan terhadap pelanggan.' },
    { char:'整理', pinyin:'zhěnglǐ', meaning:'mengatur, merapikan', example:'如果你做完你可以整理一下', exampleIndo:'Jika kamu sudah selesai, rapiin ya.' },
    { char:'整顿', pinyin:'zhěngdùn', meaning:'merapikan/membenahi secara keseluruhan(perbaikan besar)', example:'审核后，品质部决定整顿品质检验流程。', exampleIndo:'Setelah selesai audit, departemen QC memutuskan untuk membenahi proses inspeksi kualitas.' },
    { char:'糊盒机', pinyin:'húhéjī', meaning:'folder gluer/mesin perekat kotak/mesin pelipat & perekat kotak ', example:'这个糊盒机没开。你查一下。', exampleIndo:'Mesin folder gluer ini tidak menyala. kamu cek dulu.' },
    { char:'剩余', pinyin:'shèngyú', meaning:'sisa, tersisa', example:'为什么有这么多剩余？你查了没有？。', exampleIndo:'Mengapa ada begitu banyak sisa? Apakah kamu sudah memeriksa?' },
    { char:'打扫', pinyin:'dǎsǎo', meaning:'membersihkan', example:'这个地方必须干净，你清扫一下。', exampleIndo:'Tempat ini harus bersih, kamu harus membersihkannya.' },
    { char:'输入', pinyin:'shūrù', meaning:'memasukkan（input）', example:'请你输入新报告。', exampleIndo:'Tolong input laporan baru.' },
    { char:'输出', pinyin:'shūchū', meaning:'hasil produksi (output), keluaran', example:'昨天的产量是多少？', exampleIndo:'Berapa hasil produksi kemarin?' },
    { char:'打散', pinyin:'dǎsàn', meaning:'terlepas, pecah menjadi beberapa bagian', example:'你看到桌子上有一个产品被打散了吗？', exampleIndo:'Apakah kamu melihat ada satu produk di atas meja yang terlepas?' },
    { char:'封盖', pinyin:'fēnggài', meaning:'menutup/memasang penutup (cap)', example:'品质员有没有在验货封盖？', exampleIndo:'Apakah petugas QC sedang memeriksa proses pemasangan penutup?' },
    { char:'协作', pinyin:'xiézuò', meaning:'bekerja sama, berkolaborasi', example:'品质部跟工程部需要协作。', exampleIndo:'Departemen QC dan Departemen Engineering perlu bekerja sama.' },
    { char:'组长', pinyin:'zǔzhǎng', meaning:'ketua tim, leader', example:'组长在哪里？你看到了吗？', exampleIndo:'Di mana ketua tim? Apakah kamu melihatnya?' },
    { char:'红帽子', pinyin:'hóng màozi', meaning:'topi merah', example:'组长是戴红帽子的男生。', exampleIndo:'Ketua tim adalah laki-laki yang memakai topi merah.' },
    { char:'拉线', pinyin:'lāxiàn', meaning:'line produksi (production line)', example:'我在拉线上看到评审员。', exampleIndo:'Saya melihat audit di lini produksi.' },
    { char:'解决', pinyin:'jiějué', meaning:'menyelesaikan, mengatasi', example:'如果发现问题，品质员必须提出解决方法。', exampleIndo:'Jika menemukan masalah, petugas QC harus mengajukan solusi.' },
    { char:'高效', pinyin:'gāoxiào', meaning:'efisien', example:'移印部必须高效工作。', exampleIndo:'Departemen Pad Printing harus bekerja secara efisien.' },
    { char:'来不及', pinyin:'láibují', meaning:'tidak keburu, terlambat', example:'如果来不及，你安排人帮忙。', exampleIndo:'Kalau tidak keburu, atur orang untuk membantu.' },
    { char:'创新', pinyin:'chuàngxīn', meaning:'berinovasi, inovasi', example:'到中国以后，你可以创新。', exampleIndo:'Setelah ke Tiongkok, kamu bisa berinovasi.' },
    { char:'注塑部', pinyin:'zhùsù bù', meaning:'Departemen Injection Molding', example:'我会继续在注塑部锻炼自己。', exampleIndo:'Saya akan terus mengembangkan kemampuan di Departemen Injection Molding.' },
    { char:'喷油部', pinyin:'pēnyóu bù', meaning:'Departemen Spray Painting', example:'这个问题由喷油部负责。', exampleIndo:'Masalah ini menjadi tanggung jawab Departemen Spray Painting.' },
    { char:'移印部', pinyin:'yíyìn bù', meaning:'Departemen Pad Printing', example:'你告诉移印部，这一批不能用。', exampleIndo:'Tolong beri tahu Departemen Pad Printing bahwa batch ini tidak boleh digunakan.' },
    { char:'装配部', pinyin:'zhuāngpèi bù', meaning:'Departemen Assembly', example:'在装配的时候，有很多投诉。', exampleIndo:'Selama proses assembly, ada banyak keluhan.' },
    { char:'品管部', pinyin:'pǐnguǎn bù', meaning:'Departemen Quality Control (QC)', example:'今天品管部下午两点下班。', exampleIndo:'Hari ini Departemen QC pulang kerja pukul dua siang.' },
    { char:'工程部', pinyin:'gōngchéng bù', meaning:'Departemen Engineering', example:'工程部在我们的左边。', exampleIndo:'Departemen Engineering berada di sebelah kiri kami.' },
    { char:'实验室', pinyin:'shíyànshì', meaning:'laboratorium', example:'实验室在装配部里面。', exampleIndo:'Laboratorium berada di dalam Departemen Assembly.' },
    { char:'混色室', pinyin:'hùnsèshì', meaning:'ruang pencampuran warna', example:'我不知道混色室在哪里。', exampleIndo:'Saya tidak tahu ruang pencampuran warna ada di mana.' },
    { char:'印刷部', pinyin:'yìnshuā bù', meaning:'Departemen Printing', example:'印刷部有三个班。', exampleIndo:'Departemen Printing memiliki tiga shift.' },
    { char:'人事部', pinyin:'rénshì bù', meaning:'Departemen HR', example:'第一天上班前，你必须先到人事部报到。', exampleIndo:'Sebelum hari pertama bekerja, kamu harus melapor ke Departemen HR.' },
    { char:'仓库', pinyin:'cāngkù', meaning:'gudang', example:'我一般会到仓库检查样板和SAS样板。', exampleIndo:'Biasanya saya pergi ke gudang untuk memeriksa sampel dan sampel SAS.' },
    { char:'采购部', pinyin:'cǎigòu bù', meaning:'Departemen Purchasing', example:'他问采购部，为什么我们的工资比较低。', exampleIndo:'Dia bertanya kepada Departemen Purchasing mengapa gaji kami lebih rendah.' },
];
...
const quizWords = [
    ...
    { char:'内部', pinyin:'nèibù', meaning:'dalam, internal' },
    { char:'外部', pinyin:'wàibù', meaning:'luar, eksternal' },
    { char:'评审', pinyin:'píngshěn', meaning:'penilaian, evaluasi, review' },
    { char:'验货', pinyin:'yànhuò', meaning:'inspeksi, pemeriksaan barang' },
    { char:'验证', pinyin:'yànzhèng', meaning:'verifikasi, memastikan' },
    { char:'来料', pinyin:'láiliào', meaning:'material masuk (incoming material/IQC)' },
    { char:'移印', pinyin:'yíyìn', meaning:'pad printing, cetak transfer' },
    { char:'喷油', pinyin:'pēnyóu', meaning:'spray painting, pengecatan semprot' },
    { char:'工程', pinyin:'gōngchéng', meaning:'teknik, engineering' },
    { char:'文件', pinyin:'wénjiàn', meaning:'dokumen' },
    { char:'菲林', pinyin:'fēilín', meaning:'film, pelat cetak' },
    { char:'估计', pinyin:'gūjì', meaning:'memperkirakan, mengira' },
    { char:'运营', pinyin:'yùnyíng', meaning:'operasional, menjalankan operasi' },
    { char:'继续', pinyin:'jìxù', meaning:'melanjutkan' },
    { char:'拷贝纸', pinyin:'kǎobèizhǐ', meaning:'kertas tisu, copy paper' },
    { char:'芯纸', pinyin:'xīnzhǐ', meaning:'kertas inti (core paper)' },
    { char:'不足', pinyin:'bùzú', meaning:'kurang, tidak mencukupi (formal)' },
    { char:'不够', pinyin:'búgòu', meaning:'tidak cukup' },
    { char:'诚信', pinyin:'chéngxìn', meaning:'integritas, kejujuran, dapat dipercaya' },
    {  char:'整理', pinyin:'zhěnglǐ', meaning:'merapikan, menyusun' },
    { char:'整顿', pinyin:'zhěngdùn', meaning:'membenahi, menertibkan secara menyeluruh' },
    { char:'糊盒机', pinyin:'húhéjī', meaning:'folder gluer, mesin pelipat dan perekat kotak' },
    { char:'剩余', pinyin:'shèngyú', meaning:'sisa, tersisa' }, 
    { char:'打扫', pinyin:'dǎsǎo', meaning:'membersihkan' },
    { char:'输入', pinyin:'shūrù', meaning:'memasukkan (input)' },
    { char:'输出', pinyin:'shūchū', meaning:'hasil keluaran, output' },
    { char:'打散', pinyin:'dǎsàn', meaning:'terlepas, pecah menjadi beberapa bagian' },
    { char:'封盖', pinyin:'fēnggài', meaning:'menutup, memasang penutup (cap)' },   
    { char:'协作', pinyin:'xiézuò', meaning:'bekerja sama, berkolaborasi' },
    { char:'组长', pinyin:'zǔzhǎng', meaning:'ketua tim, leader' },
    { char:'红帽子', pinyin:'hóng màozi', meaning:'topi merah' },
    { char:'拉线', pinyin:'lāxiàn', meaning:'lini produksi (production line)' },
    { char:'解决', pinyin:'jiějué', meaning:'menyelesaikan, mengatasi' },
    { char:'高效', pinyin:'gāoxiào', meaning:'efisien, berdaya guna tinggi' },
    { char:'来不及', pinyin:'láibují', meaning:'tidak keburu, terlambat' },
    { char:'创新', pinyin:'chuàngxīn', meaning:'berinovasi, inovasi' },
    { char:'注塑部', pinyin:'zhùsù bù', meaning:'Departemen Injection Molding' },
    { char:'喷油部', pinyin:'pēnyóu bù', meaning:'Departemen Spray Painting' },
    { char:'移印部', pinyin:'yíyìn bù', meaning:'Departemen Pad Printing' },
    { char:'装配部', pinyin:'zhuāngpèi bù', meaning:'Departemen Assembly' },
    { char:'品管部', pinyin:'pǐnguǎn bù', meaning:'Departemen Quality Control (QC)' },
    { char:'工程部', pinyin:'gōngchéng bù', meaning:'Departemen Engineering' },
    { char:'实验室', pinyin:'shíyànshì', meaning:'laboratorium' },
    { char:'混色室', pinyin:'hùnsèshì', meaning:'ruang pencampuran warna' },
    { char:'印刷部', pinyin:'yìnshuā bù', meaning:'Departemen Printing' },
    { char:'人事部', pinyin:'rénshì bù', meaning:'Departemen Human Resources (HR)' },
    { char:'仓库', pinyin:'cāngkù', meaning:'gudang' },
    { char:'采购部', pinyin:'cǎigòu bù', meaning:'Departemen Purchasing' },
];
